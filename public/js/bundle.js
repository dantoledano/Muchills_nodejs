...
const bookTour = async tourId => {
  const stripe = Stripe('pk_test_51PxBDKP8Nbh1DqU6eR3PwboO2i2h1ZcxH1dCrf7ikLpussznIKBrB3eTDYmHcEQ3ei3n9fU9Y4Rc3PAjfPBBnwIs00hOfLJsiF');
  try {
...
const signup = async (name, email, password, passwordConfirm) => {
  try {
    ...
    document.querySelector('.btn--signup__form').textContent = 'Sign up';
    (0, _alerts.showAlert)('error', err.response.data.message);
  }
};
...
},{}],"reviews.js":[function(require,module,exports) {
"use strict";
...
const leaveReview = async (review, rating, tour) => {
  try {
    const res = await (0, _axios.default)({
      method: 'POST',
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","../../utils/appError":"../../utils/appError.js"}],"post.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.likePost = exports.leaveAComment = exports.addPost = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
const AppError = require('../../utils/appError');
const addPost = async (text, photos) => {
  try {
    ...
    if (res.data.status === 'success') {
      (0, _alerts.showAlert)('success', 'Post submitted successfully');
      window.setTimeout(() => {
        location.reload(true);
      }, 200);
    }
...
exports.leaveAComment = leaveAComment;
...
if (reviewForm) {
  reviewForm.addEventListener('submit', async e => {
    ...
    await (0, _reviews.leaveReview)(review, rating, tourId);
...
if (addPostForm) {
  addPostForm.addEventListener('submit', async e => {
    ...
    await (0, _post.addPost)(content, photos);
  });
}
const commetOnPost = () => {
  console.log('hello!');
  commentForms.forEach(form => {
    ...
    form.addEventListener('submit', async e => {
      ...
      await (0, _post.leaveAComment)(text, postId);
      textarea.value = '';
...
},{"core-js/modules/web.timers.js":"../../node_modules/core-js/modules/web.timers.js","core-js/modules/web.immediate.js":"../../node_modules/core-js/modules/web.immediate.js","core-js/modules/web.dom.iterable.js":"../../node_modules/core-js/modules/web.dom.iterable.js","./leaflet":"leaflet.js","./login":"login.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js","./signup":"signup.js","./reviews":"reviews.js","./post":"post.js"}]},{},["index.js"], null)
